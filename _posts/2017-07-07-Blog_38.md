---
layout: post
title: Coding and Deploying :)
---
Hello, Everyone :)

This past week I was working on developing the "pop-up" math questions that the player encounters while playing Hopper's Fables. In addition, 
...
surprise the player so they do not expect it :)

The way I started doing these "pop-up" math questions was by using the html form tag (which is a bit complicated), and 
creating many functions but luckily my research mate Deja had a better solution :) 

As far as deploying our website, I have only got it to display an "ugly skeleton" version. I will attach a photo below of what it looks like, and what 
